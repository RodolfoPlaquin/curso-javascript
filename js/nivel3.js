...
const imagenKittens= document.querySelector('img');
imagenKittens.src = "img/kittens.jpeg"
...
const nodoLogo = document.createElement('img');
nodoLogo.src = 'img/woman_bw.jpg';

document.querySelector('header').appendChild(nodoLogo);
